/*
 * @description 类型分配
 * @link https://github.com/type-challenges/type-challenges/blob/master/questions/869-extreme-distributeunions/README.md
 */

/* _____________ Your Code Here _____________ */

type DistributeUnionsArrayHelper<T extends unknown[]> = T extends [
  infer F,
  ...infer R
]
         ...
         ? [DistributeUnions<F>, ...DistributeUnionsArrayHelper<R>]
  : [];

type DistributeUnionsObjectHelper<T extends Record<string, any>> = {
  [P in keyof T]: DistributeUnions<T[P]>;
};

type DistributeUnions<T, P extends unknown = T> = P extends T
  ? P extends unknown[]
    ? DistributeUnionsArrayHelper<P>
    : P extends Record<string, any>
    ? DistributeUnionsObjectHelper<P>
    : P
  : any;
